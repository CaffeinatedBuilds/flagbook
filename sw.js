...
const CACHE = 'flagbook-v11';
const ASSETS = [
  './', './index.html', './css/app.css', './manifest.webmanifest',
  './js/util.js', './js/geometry.js', './js/store.js', './js/media.js', './js/recorder.js', './js/rotation.js', './js/field.js',
  './js/views/home.js', './js/views/roster.js', './js/views/practices.js', './js/views/games.js',
  './js/views/playbook.js', './js/views/viewer.js', './js/views/clips.js', './js/views/recorder.js', './js/views/print.js', './js/views/settings.js', './js/app.js',
